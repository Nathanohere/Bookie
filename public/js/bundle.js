...
exports.signup = exports.logout = exports.login = exports.deleteCart = exports.checkout = exports.addToCart = void 0;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          (0, _alert.showAlert)('error', 'Error, please try again later');
        case 10:
        case "end":
...
var addToCart = exports.addToCart = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(bookId) {
    var quantity, res;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          quantity = 1; // iconCartSpan.textContent = quantity;
          _context4.prev = 1;
          _context4.next = 4;
          return (0, _axios.default)({
            method: 'POST',
        ...
        case 8:
          ...
          (0, _alert.showAlert)('error', 'Error adding cart');
        case 11:
        case "end":
...
var deleteCart = exports.deleteCart = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 7:
          ...
          (0, _alert.showAlert)('error', 'Error removing cart');
        case 10:
        case "end":
  ...
  return function deleteCart(_x7) {
    return _ref5.apply(this, arguments);
  };
}();
var checkout = exports.checkout = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(email, amount) {
    var res, data, redirectUrl;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 8:
          ...
          (0, _alert.showAlert)('error', 'Error making payment');
        case 11:
        case "end":
  ...
  return function checkout(_x8, _x9) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Password reset link sent successfully');
          }
          _context.next = 10;
          break;
        case 7:
...
var resetPassword = exports.resetPassword = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(password, confirmPassword, token) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
// DOM ELEMENTS
var signUpForm = document.querySelector('.frm-signup');
var loginForm = document.querySelector('.form');
var logOutBtn = document.querySelector('.butn--form');
var userDataForm = document.querySelector('.frm-data');
var userPasswordForm = document.querySelector('.frm-password');
var forgotPasswordForm = document.querySelector('.fgtPass');
var resetPasswordForm = document.querySelector('.rstPass');
var addToCartForm = document.querySelector('.crt');
var deleteCartForm = document.querySelector('.dlt');
var checkoutForm = document.querySelector('.chkout');
if (signUpForm) signUpForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var name = document.getElementById('name').value;
  var email = document.getElementById('email').value;
  var password = document.getElementById('password').value;
  (0, _test.signup)(name, email, password);
});
if (loginForm) loginForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var email = document.getElementById('email').value;
  var password = document.getElementById('password').value;
  (0, _test.login)(email, password);
});
if (logOutBtn) logOutBtn.addEventListener('submit', _test.logout);
...
if (forgotPasswordForm) forgotPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.next = 6;
          return (0, _resetPassword.resetPassword)(password, confirmPassword, token);
        case 6:
        case "end":
          return _context3.stop();
      }
...
if (addToCartForm) addToCartForm.addEventListener('submit', /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          e.preventDefault();
          // alert(2);
          bookCart = document.getElementById('crt-items').value;
          _context4.next = 4;
          return (0, _test.addToCart)(bookCart);
        case 4:
        case "end":
          return _context4.stop();
      }
...
if (deleteCartForm) deleteCartForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(e) {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          e.preventDefault();
          book = document.getElementById('dlt-item').value;
          _context5.next = 4;
          return (0, _test.deleteCart)(book);
        case 4:
        case "end":
          return _context5.stop();
      }
...
if (checkoutForm) checkoutForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(e) {
    var userEmail, totalClass, totalClassText, numValue;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          e.preventDefault();
          userEmail = document.getElementById('chk-use').value;
          totalClass = document.querySelector('.totalBill');
          totalClassText = totalClass.textContent;
          numValue = parseFloat(totalClassText.replace(/[^0-9.]/g, ''));
          _context6.next = 7;
          return (0, _test.checkout)(userEmail, numValue);
        case 7:
        case "end":
          return _context6.stop();
      }
